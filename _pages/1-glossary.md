...
10. *Acid Test*: A measure of immediate liquidity; the ratio of quick assets to current liabilities, aka the Quick Ratio:<br>$$A.T. =  \Large \frac{Cash~ +~ Marketable~ Securities~ +~ A/R}{Current~ Liabilities}$$

11. *ADIP*: "Additional Paid-In Capital," This is an owner's equity act title.    
   
12. *Adjusting entries*: Journal entries are made to update accounts for items that were **not recorded** during the accounting period 

13. *Adjustment*: A change made to an account that reflects its accurate or updated balances at the end of a period.     

14. *ALORE*: = Assets, Liabilities, Owner's Equity, Revenue, Expenses   
...
16. *Balance Ledger Form*: A balance ledger form is a two-column spreadsheet (debit and credit) that presents each Account's balances and net changes during a specific period. A ledger account form that shows the account balance after each Entry is posted.   

17. *Balance sheet*: A formal report of a business's financial assets, liabilities, and owner's equity at a specific point in time; **Uses: A = L + E**   

18. *Book Value*: The remaining cost of an asset after factoring in accumulated Depreciation.<br>- Book Value = Equipment - Accumulated Depreciation      

19. *Capital*: Financial investment in a business; **Owner's equity**

20. *Cash discount*: A reduction in the price of a good or service given to a customer for paying their bill promptly.   

21. *Chart of Accounts*: A master list of all accounts used by a company, organized by category and code for easy reference.   

22. *Classification*: Grouping transactions into relevant accounts. See Chart of Accounts.  

23. *Closing Journal Entries*: Closing entries transfer temporary account balances, like revenue and expenses, into permanent accounts like retained earnings, resetting temporary accounts to zero and preparing them for the next period.   

24. *Compound Entry*: A single journal entry affects multiple accounts, usually with debits and credits, **One transaction, multiple accounts**.     

25. *Contra Account*: An account with an average balance opposite that of a related account. 

26. *Contra Asset Account*: A contra account reduces the balance of an asset account, for example, *Accumulated Deprection-Equipment*. 

27. *Contra revenue account*: An account with a debit balance that reduces revenue, typically for sales returns, allowances, or discounts.

28. *Control account*: An account in the general ledger that summarizes the balances of all accounts in a specific subsidiary ledger.

29. *Correcting Entry*: An entry made to fix or adjust an error in a previous entry.

30. *Cost of goods sold (COGS)*: The direct costs associated with producing the goods or services sold by a business during a specific period.

31. *Credit*: Think RIGHT hand

32. *Credit memorandum*: A document issued to a customer acknowledging a reduction in their account due to a return, allowance, or tax adjustment.

33. *Credit terms*: The specific credit sales conditions, including the time a customer has to pay and any applicable penalties for late payments.

34. *Current Asset*: A current asset is a resource a company expects to use, sell, or convert to cash within one year. See also *Non-Current Asset*.     

35. *Debit*: Think LEFT hand 

36. *DEA-LER*: Dividends, Expenses, Assets / Liabilities, Equity, Revenue; 1-3=Debits, 4-6=Credits   

37. *Double-declining-depreciation*: Rate is twice simple linear depreciation.   

38. *Doubling error*: occurs when a transaction is entered twice, for example, a credit balance in the debit column.   

39. *Drawing Account*: An account that records owner withdrawals from the business, reducing their equity.   
...
41. *DEAR-CLIP*: Drawings + Expenses + Assets + Receivables = Capital + Liabilities + Income + Payables     

42. *Declining Book Value*: Each year's depreciation expense is calculated based on the asset's remaining book value at the beginning of that year, resulting in decreasing depreciation amounts over time.
    
43. *Depreciation*: The systematic allocation of an asset's cost over its useful life as an expense, **Spreads the cost of an asset over time**.   

44. *EBITDA*: **Earnings Before Interest, Tax, Depreciation & Amortization** is a financial metric to assess a company's operational profitability. It represents the profit generated by the core business operations, excluding the impact of financing decisions (interest expense), government regulations (taxes), and non-cash expenses related to assets (Depreciation and amortization).

45. *EBITDA margin*: Provide insights into a company's operational efficiency and profitability. $$EBITDA~ ~margin = \Large \frac{EBITDA}{Revenue}$$

46. *Fair market value*: FMV is the price an informed and willing buyer pays an informed and willing seller for an asset, assuming neither is under undue pressure. 
   
47. *Financial interest*: A claim on a company's profits or assets, typically represented by ownership through shares or investments, granting rights to dividends, voting power, and potential capital appreciation. An economic stake in a company, expecting financial rewards.   

48. *Freight In account*: An account used to record the cost of transporting goods purchased from a supplier to the buyer's location.
     
49. *Footing*: A calculation and sum written showing debits or credits of a column to check for accuracy.   

50. *Fundamental accounting equation*: **A = L + E**  See also: DEAR-CLIP   
